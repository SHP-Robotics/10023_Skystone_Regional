...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 4.0/3; // output (wheel) speed / input (motor) speed 15/20
    public static double TRACK_WIDTH = 14.5; //14.5
    ...
    //servo constants
    public static final double FOUNDATION_LEFT_UP = 0.0;
    public static final double FOUNDATION_LEFT_DOWN = 0.37;
    public static final double FOUNDATION_RIGHT_UP = 1.0;
    public static final double FOUNDATION_RIGHT_DOWN = 0.65;

    public static final double MAX_INTAKE = 0.5;
    public static final double MAX_INTAKE_TELEOP = 0.5;
}
