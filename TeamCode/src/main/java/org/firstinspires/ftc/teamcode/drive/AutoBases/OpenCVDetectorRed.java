...
@Autonomous(name= "OpenCVDetectorBlue")
@Disabled
public class OpenCVDetectorRed extends LinearOpMode {
    ...
    private static float offsetX = -2.0f / 8f;//changing this moves the three rects and the three circles left or right, range : (-2, 2) not inclusive
    private static float offsetY = 1.65f / 8f;//changing this moves the three rects and circles up or down, range: (-4, 4) not inclusive
